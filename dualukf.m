function out=dualukf(dynfun,obsfun,data,time,x0,R,V,P0x,P0q,Re,Rr,q0,param)
%
%DualUKF: Dual Estimation Unscented Kalman Filter
%     DUALUKF(dynfun,obsfun,data,time,x0,R,V,P0x,P0q,Re,Rr,q0)
